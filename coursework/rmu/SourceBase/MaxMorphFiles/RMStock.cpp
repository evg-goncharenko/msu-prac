...
CRMLexem::CreateByNumber(int SynClass) {
    ...
    switch (SynClass) {
        case ERM_PARTICLE:
            Lexem = new CRMSclasses::CRMParticle;
            break;  // (1)
        case ERM_INTERJECTION:
            Lexem = new CRMSclasses::CRMInterjection;
            break;  // (2)
        case ERM_PERSONAL_PRONOUN:
            Lexem = new CRMSclasses::CRMPersonalPronoun;
            break;  // (3-1)
        case ERM_REFLEXIVE_PRONOUN:
            Lexem = new CRMSclasses::CRMReflexivePronoun;
            break;  // (3-2)
        case ERM_PRONOUN:
            Lexem = new CRMSclasses::CRMPronoun;
            break;  // (3-3)
        case ERM_NUMBER_ONE:
            Lexem = new CRMSclasses::CRMNumberOne;
            break;  // (4-1)
        case ERM_NUMBER_TWO:
            Lexem = new CRMSclasses::CRMNumberTwo;
            break;  // (4-2)
        case ERM_NUMBER_THREE:
            Lexem = new CRMSclasses::CRMNumberThree;
            break;  // (4-3)
        case ERM_NUMBER:
            Lexem = new CRMSclasses::CRMNumber;
            break;  // (4-4)
        case ERM_NUMBER_BIFORM:
            Lexem = new CRMSclasses::CRMNumberBiForm;
            break;  // (4-5)
        case ERM_NOUN_MALE_INANIMATE:
            Lexem = new CRMSclasses::CRMNounMaleInanimate;
            break;  // (7-1)
        case ERM_NOUN_MALE_ANIMATE:
            Lexem = new CRMSclasses::CRMNounMaleAnimate;
            break;  // (7-2)
        case ERM_NOUN_FEMALE_INANIMATE:
            Lexem = new CRMSclasses::CRMNounFemaleInanimate;
            break;  // (7-3)
        case ERM_NOUN_FEMALE_ANIMATE:
            Lexem = new CRMSclasses::CRMNounFemaleAnimate;
            break;  // (7-4)
        case ERM_NOUN_NEUTER_INANIMATE:
            Lexem = new CRMSclasses::CRMNounNeuterInanimate;
            break;  // (7-5)
        case ERM_NOUN_NEUTER_ANIMATE:
            Lexem = new CRMSclasses::CRMNounNeuterAnimate;
            break;  // (7-6)
        case ERM_NOUN_MALEFEMALE_ANIMATE:
            Lexem = new CRMSclasses::CRMNounMaleFemaleAnimate;
            break;  // (7-7)
        case ERM_NOUN_MALE:
            Lexem = new CRMSclasses::CRMNounMale;
            break;  // (7-8)
        case ERM_NOUN_MALE_OR_FEMALE_INANIMATE:
            Lexem = new CRMSclasses::CRMNounMaleOrFemaleInanimate;
            break;  // (7-9)
        case ERM_NOUN_MALE_OR_FEMALE_ANIMATE:
            Lexem = new CRMSclasses::CRMNounMaleOrFemaleAnimate;
            break;  // (7-10)
        case ERM_NOUN_FEMALE:
            Lexem = new CRMSclasses::CRMNounFemale;
            break;  // (7-11)
        case ERM_NOUN_NEUTER_OR_FEMALE_INANIMATE:
            Lexem = new CRMSclasses::CRMNounNeuterOrFemaleInanimate;
            break;  // (7-12)
        case ERM_NOUN_NEUTER:
            Lexem = new CRMSclasses::CRMNounNeuter;
            break;  // (7-13)
        case ERM_NOUN_NEUTER_OR_MALE_ANIMATE:
            Lexem = new CRMSclasses::CRMNounNeuterOrMaleAnimate;
            break;  // (7-14)
        case ERM_NOUN_CONST_NEUTER_INANIMATE:
            Lexem = new CRMSclasses::CRMNounNeuterConstInanimate;
            break;  // (7-15)
        case ERM_NOUN_NEUTER_OR_MALE_INANIMATE:
            Lexem = new CRMSclasses::CRMNounNeuterOrMaleInimate;
            break;  // (7-16)
        case ERM_NOUN_PROPER_FEMALE_ANIMATE:
            Lexem = new CRMSclasses::CRMNounProperFemaleAnimate;
            break;  // (7-17)
        case ERM_NOUN_PROPER_MALE_ANIMATE:
            Lexem = new CRMSclasses::CRMNounProperMaleAnimate;
            break;  // (7-18)
        case ERM_NOUN_PROPER_MALEFEMALE_ANIMATE:
            Lexem = new CRMSclasses::CRMNounProperMaleFemaleAnimate;
            break;  // (7-19)
        case ERM_NOUN_HYPOCOR_FEMALE_ANIMATE:
            Lexem = new CRMSclasses::CRMNounHypocorFemaleAnimate;
            break;  // (7-20)
        case ERM_NOUN_HYPOCOR_MALE_ANIMATE:
            Lexem = new CRMSclasses::CRMNounHypocorMaleAnimate;
            break;  // (7-21)
        case ERM_NOUN_HYPOCOR_MALEFEMALE_ANIMATE:
            Lexem = new CRMSclasses::CRMNounHypocorMaleFemaleAnimate;
            break;  // (7-22)
        case ERM_NOUN_PROPER_FEMALE_INANIMATE:
            Lexem = new CRMSclasses::CRMNounProperFemaleInanimate;
            break;  // (7-23)
        case ERM_NOUN_PROPER_MALE_INANIMATE:
            Lexem = new CRMSclasses::CRMNounProperMaleInanimate;
            break;  // (7-24)
        case ERM_NOUN_PROPER_SURNAME:
            Lexem = new CRMSclasses::CRMNounProperSurname;
            break;  // (7-25)
        case ERM_ADJECTIVE:
            Lexem = new CRMSclasses::CRMAdjective;
            break;  // (8-1)
        case ERM_PRONOUN_ADJECTIVE:
            Lexem = new CRMSclasses::CRMPronounAdjective;
            break;  // (8-2)
        case ERM_NUMBER_ORDINAL:
            Lexem = new CRMSclasses::CRMNumberOrdinal;
            break;  // (8-3)
        case ERM_PARTICIPLE:
            break;  // (8-4)
        case ERM_POSSESIVE_ADJECTIVE:
            Lexem = new CRMSclasses::CRMPossesiveAdjective;
            break;  // (8-5)
        case ERM_VERB_IRREFLEXIVE_INTRANSITIVE_IMPERFECTIVE:
            Lexem = new CRMSclasses::CRMVerbIrreflexiveIntransitiveImperfective;
            break;  // (9-1)
        case ERM_VERB_IRREFLEXIVE_INTRANSITIVE_PERFECTIVE:
            Lexem = new CRMSclasses::CRMVerbIrreflexiveIntransitivePerfective;
            break;  // (9-2)
        case ERM_VERB_IRREFLEXIVE_TRANSITIVE_IMPERFECTIVE:
            Lexem = new CRMSclasses::CRMVerbIrreflexiveTransitiveImperfective;
            break;  // (9-3)
        case ERM_VERB_IRREFLEXIVE_TRANSITIVE_PERFECTIVE:
            Lexem = new CRMSclasses::CRMVerbIrreflexiveTransitivePerfective;
            break;  // (9-4)
        case ERM_VERB_REFLEXIVE_IMPERFECTIVE:
            Lexem = new CRMSclasses::CRMVerbReflexiveImperfective;
            break;  // (9-5)
        case ERM_VERB_REFLEXIVE_PERFECTIVE:
            Lexem = new CRMSclasses::CRMVerbReflexivePerfective;
            break;  // (9-6)
        case ERM_VERB_FREQUENTATIVE_IRREFLEXIVE_INTRANSITIVE_IMPERFECTIVE:
            Lexem = new CRMSclasses::CRMVerbFrequentativeIrreflexiveIntransitiveImperfective;
            break;  // (9-7)
        case ERM_VERB_FREQUENTATIVE_IRREFLEXIVE_TRANSITIVE_IMPERFECTIVE:
            Lexem = new CRMSclasses::CRMVerbFrequentativeIrreflexiveTransitiveImperfective;
            break;  // (9-8)
        case ERM_VERB_IMPERSONAL_IRREFLEXIVE_INTRANSITIVE_IMPERFECTIVE:
            Lexem = new CRMSclasses::CRMVerbImpersonalIrreflexiveIntransitiveImperfective;
            break;  // (9-9)
        case ERM_VERB_IMPERSONAL_IRREFLEXIVE_INTRANSITIVE_PERFECTIVE:
            Lexem = new CRMSclasses::CRMVerbImpersonalIrreflexiveIntransitivePerfective;
            break;  // (9-10)
        case ERM_VERB_IMPERSONAL_IRREFLEXIVE_TRANSITIVE_IMPERFECTIVE:
            Lexem = new CRMSclasses::CRMVerbImpersonalIrreflexiveTransitiveImperfective;
            break;  // (9-11)
        case ERM_VERB_IMPERSONAL_IRREFLEXIVE_TRANSITIVE_PERFECTIVE:
            Lexem = new CRMSclasses::CRMVerbImpersonalIrreflexiveTransitivePerfective;
            break;  // (9-12)
        case ERM_VERB_IMPERSONAL_REFLEXIVE_INTRANSITIVE_IMPERFECTIVE:
            Lexem = new CRMSclasses::CRMVerbImpersonalReflexiveIntransitiveImperfective;
            break;  // (9-13)
        case ERM_VERB_IMPERSONAL_REFLEXIVE_INTRANSITIVE_PERFECTIVE:
            Lexem = new CRMSclasses::CRMVerbImpersonalReflexiveIntransitivePerfective;
            break;  // (9-14)
        case ERM_VERB_IRREFLEXIVE_INTRANSITIVE_BIFORM:
            Lexem = new CRMSclasses::CRMVerbIrreflexiveIntransitiveBiform;
            break;  // (9-15)
        case ERM_VERB_IRREFLEXIVE_TRANSITIVE_BIFORM:
            Lexem = new CRMSclasses::CRMVerbIrreflexiveTransitiveBiform;
            break;  // (9-16)
        case ERM_VERB_REFLEXIVE_INTRANSITIVE_BIFORM:
            Lexem = new CRMSclasses::CRMVerbReflexiveIntransitiveBiform;
            break;  // (9-17)
        case ERM_VERB_REFLEXIVE_INTRANSITIVE_BIFORM_EXT:
            Lexem = new CRMSclasses::CRMVerbReflexiveIntransitiveBiformExt;
            break;  // (9-18)
        case ERM_VERB_BE_IRREFLEXIVE_INTRANSITIVE:
            Lexem = new CRMSclasses::CRMVerbBeIrreflexiveIntransitive;
            break;  // (9-19)
        case ERM_PREPOSITION:
            Lexem = new CRMSclasses::CRMPreposition;
            break;  // (10)
        case ERM_CONJUNCTION:
            Lexem = new CRMSclasses::CRMConjunction;
            break;  // (11)
        case ERM_ADVERB:
            Lexem = new CRMSclasses::CRMAdverb;
            break;  // (12)
        case ERM_PREDICATIVE:
            Lexem = new CRMSclasses::CRMPredicative;
            break;  // (13)
        case ERM_PARENTHESIS:
            Lexem = new CRMSclasses::CRMParenthesis;
            break;  // (14)
    };
    return Lexem;
}
    ...
    for (i = StartPos; i < Items.Count(); ++i) {
        if (Items[i]->ItemType() == ERMPFlex) {
            ...
            for (j = 0; j < ((Flexes *)Items[i])->Items.Count(); ++j) {
                // GIG: we should codify nested results even for exact match ("����-��")
...
bool CRMParadigm::ContainsFlex(const String &Flex, int StartPos) const {
    bool Result(false);
    int i, j;
    String PFlex;
        ...
        for (i = StartPos; i < Items.Count(); i++) {
            if (Items[i]->ItemType() == ERMPFlex) {
                ...
                for (j = 0; j < pFlexes->Items.Count(); j++) {
                    PFlex = pFlexes->Items[j];
                    if (Flex.Find(PFlex) == 0) {
                        // GIG: we still need to check nested condition even in case of perfect match ("������")
                        // Nested case
                        if (pFlexes->Nested[j])
