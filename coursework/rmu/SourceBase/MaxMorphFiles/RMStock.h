...
public:
    ...
    static  String        RB;
                          CRMStockElement () :
                              DicType ( GENERAL_DIC )
                          {}
                          CRMStockElement ( const CRMStockElement& Element ) :
                              DicType ( Element.DicType )
                          {}
};
...
public:
    ...
    struct Stress
    {
        ...
        Stress () { Pos = 0; Aux = 0; Nested = NULL; };
        Stress ( const Stress& AStress ) :
            Pos ( AStress.Pos ),
            Aux ( AStress.Aux ),
...
public:
    ...
    public:
        void  Identify ( Strings & Data, unsigned long FlexPosition, const String & Properties, const CRMParadigm * const Paradigm )
		{
            ...
            switch ( FlexPosition )
            {
                case 0:   props = " animate=no gender=male number=single case=accusative"; break;
                case 1:   props = " animate=yes gender=male number=single case=accusative"; break;
                case 5:   props = " animate=any gender=neuter number=single case=accusative"; break;
                case 12:  props = " animate=any gender=female number=single case=prepositional"; break;
                case 15:  props = " animate=no gender=any number=plural case=accusative"; break;
                case 16:  props = " animate=yes gender=any number=plural case=accusative";
            }
			if (!props.IsEmpty())
			{
            ...
            switch ( Model )
            {
                ...
                case 'S':
					...
					if (_pRefNoun->GetStaticPropData() & ESPropAnimateNo)
					{
						switch ( FlexPosition )
						{
							case 0: Data.Add ( Properties + " case=accusative number=single" ); break;
							case 5: Data.Add ( Properties + " case=accusative number=plural" ); break;
						}
					}
					if (_pRefNoun->GetStaticPropData() & ESPropAnimateYes)
					{
						switch ( FlexPosition )
						{
							case 1: Data.Add ( Properties + " case=accusative number=single" ); break;
							case 6: Data.Add ( Properties + " case=accusative number=plural" ); break;
						}
					}
					break;
                case 'G':
                    switch ( FlexPosition )
                    {
                        case 2: Data.Add ( Properties + " case=prepositional number=single" ); break;
                        case 5:
							if (_pRefNoun->GetStaticPropData() & ESPropAnimateNo)
...
public:
	...
	public:
		void Identify ( Strings & Data, unsigned long FlexPosition, const String & Properties, const CRMParadigm * const Paradigm )
		{
			...
			switch ( FlexPosition )
			{
			case 0:   Data.Add (form + " animate=no gender=male number=single case=accusative" ); break;
			case 1:   Data.Add (form + " animate=yes gender=male number=single case=accusative" ); break;
			case 5:   Data.Add (form + " animate=any gender=neuter number=single case=accusative" ); break;
			case 12:  Data.Add (form + " animate=any gender=female number=single case=prepositional" ); break;
			case 15:  Data.Add (form + " animate=no gender=any number=plural case=accusative" ); break;
			case 16:  Data.Add (form + " animate=yes  gender=any number=plural case=accusative" ); break;
			}
		}
...
public:
    class VerbHomonim: public CRMHomonim
    {
        void Identify ( Strings & Data, unsigned long FlexPosition, const String & Properties, const CRMParadigm * const Paradigm )
        {
            ...
            switch ( FlexPosition )
            {
                case 0:   Data.Add ( Data[0] + " animate=no gender=male number=single case=accusative" ); break;
                case 1:   Data.Add ( Data[0] + " animate=yes gender=male number=single case=accusative" ); break;
                case 5:   Data.Add ( Data[0] + " animate=any gender=neuter number=single case=accusative" ); break;
                case 12:  Data.Add ( Data[0] + " animate=any gender=female number=single case=prepositional" ); break;
                case 15:  Data.Add ( Data[0] + " animate=no gender=any number=plural case=accusative" ); break;
                case 16:  Data.Add ( Data[0] + " animate=yes gender=any number=plural case=accusative" ); break;
            }
			// GIG:
#ifdef _DEBUG
