...
def check_test(data_dir):
    ...
    gt = read_target(join(gt_dir, 'test_target.csv'))
...
def run_single_test(data_dir, output_dir):
    ...
    train_features = pd.read_csv(join(train_dir, 'train_features.csv')).values
    train_target = read_target(join(train_dir, 'train_target.csv'))
    test_features = pd.read_csv(join(test_dir, 'test_features.csv')).values
